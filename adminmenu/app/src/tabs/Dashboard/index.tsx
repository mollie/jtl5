...
import {
  faCreditCard, faEnvelopeOpenDollar, faEnvelopeOpenText,
  faExternalLink,
  faMoneyBill,
  faReceipt,
  faShippingFast,
      ...
      <div className="text-right">
        ...
        {legende ? <div className={"m-2 p-2"}>
          <ul>
            ...
            <li className="text-xs">
              <FontAwesomeIcon color='green' size={"xs"} icon={faEnvelopeOpenDollar}
                               title={'Zahlung vor Bestellabschluss'}/> = Zahlung vor Bestellabschluss
            </li>
            <li className="text-xs">
              <FontAwesomeIcon color='red' size={"xs"} icon={faEnvelopeOpenDollar}
                               title={'Fehler: Zahlung vor Bestellabschluss'}/> = Fehler: Zahlung vor Bestellabschluss
            </li>

            <li className="text-xs">
              <FontAwesomeIcon color='green' size={"xs"} icon={faEnvelopeOpenText}
                               title={'Zahlung nach Bestellabschluss'}/> = Zahlung nach Bestellabschluss
            </li>
            <li className="text-xs">
              <FontAwesomeIcon color='blue' size={"xs"} icon={faEnvelopeOpenText}
                               title={'Zahlung nach Bestellabschluss, zahlung vor Bestellabschluss wäre möglich!'}/> = Zahlung nach Bestellabschluss
            </li>
          </ul>
        </div> : null}

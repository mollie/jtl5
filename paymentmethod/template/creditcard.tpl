<div class="row mt-5 skip-mollie-components" style="margin: 10px">
    <div class="col order-1 col-md-6 col-12">
        <h3>{$mollieLang.cctitle}</h3>
    </div>
    {if $components == 'S'}
        <div class="col order-2 col-md-4 col-12">
            <button class="btn  btn-outline-primary btn-block" type="submit" name="skip" value="1"
                    id="skipMollieComponents">{$mollieLang.skipComponentsLink}</button>
        </div>
    {/if}
</div>
...
<div class="form-horizontal card-container" id="mollie-components">
    ...
    {if $token !== false}
        <div class="row mt-5 clear-mollie-components" style="margin: 10px">
            <div class="col order-1 col-md-6 col-12">
...
<script defer>
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (e.submitter && (e.submitter.id === 'skipMollieComponents' || e.submitter.id === 'clearMollieComponents')) {
            return true;
        }
